...
class Neuron:
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05,
              verbose=True, graph=True, step=1000):
        """Training the neuron
        X - contains input data
        Y - contains correct lables of input data
        iterations - no. of iterations to train over
        """
        ...
        # verbose - boolean to define whether or not to print info about the training
        # graph - boolean to define whether or not to graph info about training
